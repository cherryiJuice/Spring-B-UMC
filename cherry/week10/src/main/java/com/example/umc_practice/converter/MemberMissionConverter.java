...
public class MemberMissionConverter {
    ...
    public static MemberMissionResponseDTO.CompleteMissionDTO toCompleteMissionResultDTO(MemberMission memberMission) {
        return MemberMissionResponseDTO.CompleteMissionDTO.builder()
                .memberMissionId(memberMission.getId())
                .createAt(memberMission.getCreatedAt())
                .build();
    }
